    ...
    if "jpg" in imagePath1:
        if augmented and not "non_augmented" in imagePath1 or not augmented and "non_augmented" in imagePath1:
            ...
            for i in range(0, len(stats)):
                ...
                image_rec = cv2.rectangle(queryImage_rn[bb[1]:bb[1] + bb[4], bb[0]:bb[0] + bb[2], :], (bbox[0], bbox[1]),
                ...
                if color:
                    ...
                    queryFeatures_c = desc_c.computeHSV(queryImage[bb[1]:bb[1] + bb[4], bb[0]:bb[0] + bb[2], :]) # color works better without removing noise
